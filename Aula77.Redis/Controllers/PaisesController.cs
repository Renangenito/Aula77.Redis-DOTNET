    ...
    public class PaisesController : ControllerBase
    {
        ...
        private async Task<List<PaisModel>> DadosAPI()
        {
            ...
            if (response.IsSuccessStatusCode)
            {
                ...
                return NossoDeserialize<List<PaisModel>>(await response.Content.ReadAsStringAsync());
            }
            else
            {
        ...
        //Metodo desserialize
        public Objeto NossoDeserialize<Objeto>(string conteudo)
        {
            return JsonConvert.DeserializeObject<Objeto>(conteudo);
        }
    }
}
